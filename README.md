...
<p align="center">
  <video src="https://github.com/user-attachments/assets/08d4fce6-b204-4947-839b-da6863727123" width="100%" autoplay loop muted playsinline></video>
</p>
...
- 多格式规划方案导出（PDF / CSV / JSON），PDF 自动生成并上传 MinIO 对象存储
